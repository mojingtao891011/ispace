...
@implementation MusicRingListCell
...
- (void)handleLeftSwipeGestureRecognizer:(UISwipeGestureRecognizer *)recognizer
{
    if (self.buttonContainerView.hidden)
    {
        ...
        [UIView beginAnimations:@"MusicRingListCell_ShowButton" context:nil];
...
- (void)handleRightSwipeGestureRecognizer:(UISwipeGestureRecognizer *)recognizer
{
    if (!self.buttonContainerView.hidden)
    {
        [UIView beginAnimations:@"MusicRingListCell_HideButton" context:nil];
        [UIView setAnimationCurve:UIViewAnimationCurveLinear];
...
{
    if ([animationID isEqualToString:@"MusicRingListCell_HideButton"])
    {
